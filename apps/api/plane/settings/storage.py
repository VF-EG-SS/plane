...
class S3Storage(S3Boto3Storage):
    ...
    def __init__(self, request=None):
        ...
        # The API and browser can require different endpoints in local/containerized environments.
        ...
        presign_endpoint_url = self.aws_s3_public_endpoint_url
        if not presign_endpoint_url and os.environ.get("USE_MINIO") == "1":
        ...
        if presign_endpoint_url and presign_endpoint_url != self.aws_s3_endpoint_url:
